...
public static class HexRingMetrics
{
    ...
    public static Vector3 Center(float cornerRadius, int col, int r, int padding)
    {
        float factor;
        ...
        centerPosition.x = col * cornerRadius * 1.5f + col * padding;
        centerPosition.y = 0f;
        centerPosition.z = factor * (SideRadius(cornerRadius)) + r * padding;
